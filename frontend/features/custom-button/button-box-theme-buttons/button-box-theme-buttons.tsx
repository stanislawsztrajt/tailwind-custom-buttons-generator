...
interface Props {
  isCustomButtonBoxThemeDark: boolean;
  setIsCustomButtonBoxThemeDark: Dispatch<React.SetStateAction<boolean>>;
}

const ButtonBoxThemeButtons: VFC<Props> = ({
  ...
  return (
    <div className="absolute flex flex-row left-10">
      ...
      <svg
        onClick={() => setIsCustomButtonBoxThemeDark(true)}
        xmlns="http://www.w3.org/2000/svg"
...
export default ButtonBoxThemeButtons;
