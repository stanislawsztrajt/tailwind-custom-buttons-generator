...
const Footer: VFC = () =>{
  return(
    <footer className="text-gray-400 bg-gray-800 shadow mt-96 shadow-stone-50">
      <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-nowrap">
        ...
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
          ...
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            <h2 className="mb-3 text-sm font-medium tracking-widest text-white title-font">About</h2>
            <nav className="mb-10 list-none">
              <li>
                <Link href='/about'>
          ...
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            <h2 className="mb-3 text-sm font-medium tracking-widest text-white title-font">Custom button generator</h2>
            <nav className="mb-10 list-none">
              <li>
                <Link href="/custom-button-generator">
                  <a className="text-gray-400 cursor-pointer hover:text-white">Custom button generator link</a>
                </Link>
              </li>
            </nav>
          </div>
